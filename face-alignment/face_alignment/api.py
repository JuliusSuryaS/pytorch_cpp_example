...
from .models import FAN, ResNetDepth, ops_list
from .utils import *
    ...
    def get_landmarks(self, input_image, all_faces=False):
        ...
        if len(detected_faces) > 0:
            ...
            for i, d in enumerate(detected_faces):
                ...
                if self.enable_cuda or self.use_cnn_face_detector:
                    d = d.rect
                cv2.rectangle(input_image, (d.left(), d.top()), (d.right(), d.bottom()), (0,255,0),3)
                ...
                if self.landmarks_type == LandmarksType._3D:
                    ...
                    depth_pred = self.depth_prediciton_net(Variable(torch.cat((inp, heatmaps), 1), volatile=True)).data.cpu().view(68, 1)
